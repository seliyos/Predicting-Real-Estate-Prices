...
from src.error_handling import validate_shapes, check_missing_values, train_model_safe, evaluate_model_safe
...
def main():
    try:
        ...
        validate_shapes(X_train, y_train)
        ...
        for name, model in models.items():
            metrics = evaluate_model_safe(model, X_val, y_val)
